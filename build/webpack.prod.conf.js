...
if (config.build.prerender) {
  webpackConfig.plugins.push(
    ...
    //   outputDir: path.join(__dirname, `../dist/${config.build.projectName}/prerendered`),
    //   // routes: ['/', '/news', '/template', '/about', '/cooperative-client', '/introduction', '/help-center', '/login', '/register', '/solution', '/notarization', '/website-map'],
    //   routes: ['/', '/news', '/template', '/about', '/cooperative-client', '/introduction', '/help-center','/login','/register','/solution','/notarization','/website-map'],
    ...
    //      /<div id="_lvx">/i,
    //       '<div id="_lvx" data-server-rendered="true">'
    //    )
    //  },
